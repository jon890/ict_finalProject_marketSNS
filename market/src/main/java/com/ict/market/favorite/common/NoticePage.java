...
public class NoticePage {
	...
	public synchronized HashMap<String,String> noticePaging(int pageNum,int totalCount,int pageSize, int pageBlock){
		...
		if(startPage < pageBlock) {
	        sb.append("<li class='disabled'><a class='page-link' href='#' aria-label='Previous'><span aria-hidden='true'>&laquo;</span></a></li>");
	      } else {
	        sb.append("<li class='page-item'><a class='page-link' href='notice.favorite?pageNum=");
	      ...
	      for(int i = startPage; i <= endPage; i++) {
	        if(i == pageNum) {
	          sb.append("<li class='active'><a class='page-link' href='#'>");
	          sb.append(i);
	      ...
	      if(endPage < totalPage) {
	        ...
	        sb.append("<li class='disabled'><a class='page-link' href='#' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>");
	      }
