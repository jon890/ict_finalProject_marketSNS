		...
		<section>
			...
			<div id="wrapper">
				<ul class="nav nav-tabs nav-justified" role="tablist">
					<li class="nav-item"><a href="market.compare"
						class="btn btn-primary">전통시장가격</a></li>
					<li class="nav-item"><a href="mart.compare"
						class="btn btn-primary">대형마트가격</a></li>
					<li class="nav-item"><a href="compare.compare"
						class="btn btn-primary">전통시장vs대형마트</a></li>
				</ul>
