...
<div class="contact_area">
	...
	<div class="station_ride">
		...
		<div class="bus-box">
			<div class="bus"><em><a href="http://map.daum.net?busStopId=52002" class="link_wayout" target="_blank" data-logtarget data-logevent="waytogo,busstop">대인시장(서)-상행</a></em><br>
			...
			<div class="bus"><em><a href="http://map.daum.net?busStopId=52586" class="link_wayout" target="_blank" data-logtarget data-logevent="waytogo,busstop">대인시장(서)-하행</a></em><br>
			...
			<img src="resources/images/marketIntroduce/sym_bus_sq3.png"> 마을715</div>
			<div class="bus"><em><a href="http://map.daum.net?busStopId=51999" class="link_wayout" target="_blank" data-logtarget data-logevent="waytogo,busstop">대인시장(동)-상행</a></em><br>
			...
			<div class="bus"><em><a href="http://map.daum.net?busStopId=52586" class="link_wayout" target="_blank" data-logtarget data-logevent="waytogo,busstop">대인시장(동)-하행</a></em><br>
			<img src="resources/images/marketIntroduce/sym_bus_sq15.png"> 좌석06<br>
			<img src="resources/images/marketIntroduce/sym_bus_sq11.png"> 문흥39 | 운림54 | 송정98<br>
			<img src="resources/images/marketIntroduce/sym_bus_sq12.png"> 석곡87 | 지원151 | 용전184 | 419 | 518</div>	
		</div>
